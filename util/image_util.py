...
def transformation_composer(args, split: str = "train"):
    ...
    transforms = []
    if split == "train":
        if args.crop_shape is not None and args.crop_shape != args.resize_shape:
       ...
       transforms.append(t.CenterCrop((args.crop_shape, args.crop_shape)))
